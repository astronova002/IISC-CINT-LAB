...
export default function ResearchSpecialInterests() {
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col w-full">
      ...
      <main className="flex-1 w-full max-w-screen-xl mx-auto py-12 px-4">
        <h1 className="text-3xl font-bold text-blue-900 mb-4">Special Interests</h1>
        <p>This is the Special Interests page.</p>
      </main>
