...
import { ChevronRight, ChevronDown, Mail, Phone, MapPin, Award, GraduationCap, Briefcase, Users, Globe, Building, User, ExternalLink, Linkedin, BookOpen } from 'lucide-react';
...
export default function AboutChairperson() {
      ...
      content: (
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <a href="mailto:joseph@aero.iisc.ac.in" className="text-blue-800 underline hover:text-blue-600">
              joseph@aero.iisc.ac.in
            </a>
          </div>
          <div className="flex items-center gap-2">
            <MapPin size={16} className="text-blue-600" />
            <span>Office: AE101</span>
          </div>
          <div className="flex items-center gap-2">
            <Phone size={16} className="text-blue-600" />
            <span>+91 80 22932415</span>
          </div>
          <div className="flex flex-wrap gap-3 mt-4">
            <a href="https://www.linkedin.com/in/joseph-mathew-aerospace/" 
            ...
            <a href="https://iiscprofiles.irins.org/profile/3989" 
               target="_blank" rel="noopener noreferrer" 
               className="flex items-center gap-2 px-3 py-2 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="p-3 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg border-l-4 border-blue-500">
            ...
            <p className="text-sm text-gray-600">Department of Aerospace Engineering</p>
          </div>
          <div className="p-3 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border-l-4 border-purple-500">
            <h4 className="font-semibold text-purple-900">Previous Experience</h4>
            <p className="text-sm text-gray-600">Professor, IISc Bangalore</p>
            <p className="text-sm text-gray-600">Research positions in multiple countries</p>
          </div>
        </div>
      )
    },
      ...
      content: (
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              { title: "Fluid Mechanics", desc: "Advanced fluid dynamics and flow analysis" },
              { title: "Turbulence", desc: "Turbulent flow computations and LES" },
              { title: "Aeroacoustics", desc: "Sound generation and propagation" },
              { title: "Combustion", desc: "Combustion dynamics and modeling" },
              { title: "Flow Design", desc: "Aerodynamic design optimization" },
              { title: "Computational Fluid Dynamics", desc: "Numerical simulation methods" }
            ].map((area, index) => (
      ...
      content: (
        <div className="space-y-4">
          <div className="p-3 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg border-l-4 border-yellow-500">
            ...
            <p className="text-sm text-gray-600">150+ peer-reviewed publications</p>
          ...
          <div className="p-3 bg-gradient-to-r from-red-50 to-pink-50 rounded-lg border-l-4 border-red-500">
            ...
            <p className="text-sm text-gray-600">Distinguished Professor Award</p>
  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    if (moveDistance > 20) { // Increased threshold to 20px for better click detection
      setIsDragging(true);
    }
    
    if (isDragging || moveDistance > 20) {
  ...
  const handleMouseUp = () => {
    if (draggedBox !== null) {
      if (!isDragging) {
        // This was a click, not a drag - open the modal
      ...
      <main className="flex-1 w-full py-12 px-4 relative">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-blue-900 mb-4">Department Chairperson</h1>
            ...
            <div className="lg:w-2/3">
              <div className="bg-gradient-to-br from-blue-900/90 via-purple-900/90 to-indigo-900/90 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-blue-200/30 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <h2 className="text-3xl font-bold text-white mb-2 animate-fade-in">Prof. Joseph Mathew</h2>
                  <h3 className="text-xl font-semibold text-blue-200 mb-4">Chairperson, Department of Aerospace Engineering</h3>
                  <p className="text-blue-100 mb-6 leading-relaxed">
                    Distinguished professor and department chair with extensive experience in fluid mechanics, 
                    turbulence, and aeroacoustics. Leading the Department of Aerospace Engineering at IISc 
                    with expertise in computational fluid dynamics and flow design.
                  </p>
                  ...
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                    ...
                    <p className="text-sm text-blue-200">Aerodynamics • Fluid Mechanics • Turbulence • Aeroacoustics • Combustion • Flow Design</p>
                  </div>
                </div>
              </div>
            </div>
